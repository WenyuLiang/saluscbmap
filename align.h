...
using TripleType = std::tuple<uint32_t, uint32_t, int>;
...
public:
  ...
  int CandidateRef(const MappingMetadata &mapping_metadata, SequenceBatch &ref,
                   SequenceBatch &read, uint32_t &i);
  // private:
